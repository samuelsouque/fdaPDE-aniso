# Analysis of the Meuse dataset: Showing the estimation of the anisotropy
...
# Choose which variable we wish to estimate
zinc <- MeuseData$zinc
# Its plot is
...
smoothing_aniso$anisotropy
anisotropyMatrix(smoothing_aniso$anisotropy[1],smoothing_aniso$anisotropy[2])
plot(mesh)
